...
function dumpPlayer(p) {
  ...
  for (const o of ['origin','scout_difficulty','drafted_round','drafted_overall','drafted_by','foreign','nation','kbo_years','seen','talks','downUntil','mil','milKind','milLeft','natl','wbc','pen_role','pen_lock','draft_look','drafted_year'])
