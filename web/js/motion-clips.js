...
export const SWING={keys:[
  ...
  key(.62,{legL:[-.3,0,.1],legR:[0,0,0],kneeL:[.12,0,0],kneeR:[.7,0,0],armR:[-1.25,0,.1],elbowR:[-.35,0,0],armL:[-1.3,0,-.15],elbowL:[-.2,0,0],hips:[0,.5,0],spine:[0,.55,0],bodyRot:[.12,0,-.04],bodyPos:[-.05,-.055,0],bat:[.20,-.53,1],grip:[.02,-.20,.40]}),
